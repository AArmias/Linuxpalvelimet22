...
Seuraavaksi siirrytään käyttäjän omaan kotihakemistoon (teros), tässä tapauksessa siis: `cd /home/teros` ja luodaan hakemisto public_html: `mkdir public_html` ja hakemistoon käyttäjän oma kotisivu eli index.html-tiedosto: `cd /home/teros/public_html` ja `nano index.html` 
