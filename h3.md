...
Ohjelmointi 1 kurssilla koodailtiin yhtä jos toista ja myös painoindex laskuri. Alkuperäinen laskuri kertoo myös onko käyttäjä normaali painoinen vai ylipainoinen. Hieman tätä koodia riisuin ja nyt koodi vain laskee käyttäjälle painoindexin käyttäjän antaman pituuden ja painon mukaan. 
